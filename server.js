...
app.post('/api/chat', async (req, res) => {
  ...
  try {
    const apiKey = 'AIzaSyA2IguhcKunUYQToJRvahkhLqrIU2X1Kig'; // Substitua pela sua chave de API
    const response = await fetch('http://localhost:5000/api/save-message', { // Substitua pelo endpoint correto
      method: 'POST',
      headers: {
    ...
    const data = await response.json();
    const responseText = data.responseText; // Ajuste conforme a resposta da API
